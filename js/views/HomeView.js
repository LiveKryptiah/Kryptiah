 ...
 * 1. Hero flanked by mascot character clusters
 * 2. 3-Column card grid anchored by the signature asymmetric Dark Feature Card
 * 3. Interactive Page Stack Previewer teaser
 * 4. Friends of Family horizontally scrolling tweet grid
 * 5. Lifetime Bundle Call to Action banner
 */
...
export function renderHomeView() {
  ...
  return `
    <div class="homepage">
      <!-- 1. HERO SPREAD WITH FLANKING MASCOTS -->
          ...
          <div class="hero-flank-container">
            ...
            <div style="max-width: 680px; margin: 0 auto; z-index: 2;">
              ...
              <div style="margin-top: 36px; display: flex; justify-content: center; gap: 24px; font-size: 13px; color: #7e7e7d; flex-wrap: wrap;">
                ...
                <span>✓ Hairline Inset Borders (#f2f0ed)</span>
                <span>✓ 100% Perpetual License</span>
              </div>
            </div>
      ...
      <!-- 2. EXPLORE SECTIONS (3-Column Grid Anchored by Dark Feature Card) -->
      <section style="padding: 60px 0 80px 0; border-top: 1px solid #f2f0ed;">
        <div class="container">
          ...
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 16px; align-items: stretch;">
            ...
            <div class="card-dark-feature" style="display: flex; flex-direction: column; justify-content: space-between;">
              <div>
                ...
                <div style="display: flex; flex-direction: column; gap: 8px;">
                  <div style="display: flex; align-items: center; gap: 12px; background: #121212; padding: 12px; border-radius: 8px;">
                    <div style="width: 32px; height: 32px; border-radius: 50%; background: #0086fc; display: flex; align-items: center; justify-content: center; font-size: 14px; font-weight: bold;">
                      ⚛
                    </div>
                    <div>
                  ...
                  <div style="display: flex; align-items: center; gap: 12px; background: #121212; padding: 12px; border-radius: 8px;">
                    <div style="width: 32px; height: 32px; border-radius: 50%; background: #9f4fff; display: flex; align-items: center; justify-content: center; font-size: 14px; font-weight: bold;">
                      🌊
                    </div>
                    <div>
                  ...
                  <div style="display: flex; align-items: center; gap: 12px; background: #121212; padding: 12px; border-radius: 8px;">
                    <div style="width: 32px; height: 32px; border-radius: 50%; background: #00c978; display: flex; align-items: center; justify-content: center; font-size: 14px; font-weight: bold;">
                      📱
                    </div>
                    <div>
                  ...
                  <div style="display: flex; align-items: center; gap: 12px; background: #121212; padding: 12px; border-radius: 8px;">
                    <div style="width: 32px; height: 32px; border-radius: 50%; background: #ff58ae; display: flex; align-items: center; justify-content: center; font-size: 14px; font-weight: bold;">
                      ✦
                    </div>
                    <div>
              ...
              <div style="margin-top: 24px; pt-4; border-top: 1px solid rgba(255,255,255,0.1);">
      ...
      <!-- 3. INTERACTIVE PAGE STACK MIXER TEASER -->
      <section style="background: #f2f0ed; padding: 72px 0; border-top: 1px solid #e5d5c3; border-bottom: 1px solid #e5d5c3;">
        <div class="container">
          <div style="text-align: center; max-width: 600px; margin: 0 auto 36px auto;">
            <span class="badge-status badge-mint" style="margin-bottom: 12px;">INTERACTIVE BUILDER</span>
          ...
          <div style="background: #ffffff; border-radius: 14px; padding: 24px; box-shadow: inset 0 0 0 1px #f2f0ed; max-width: 900px; margin: 0 auto;">
            ...
            <div style="display: flex; flex-direction: column; gap: 8px; background: #fbfaf9; border-radius: 10px; padding: 14px; box-shadow: inset 0 0 0 1px #f2f0ed;">
              <div style="padding: 12px; background: #ffffff; border-radius: 6px; box-shadow: inset 0 0 0 1px #f2f0ed; font-size: 13px; font-weight: 500; display: flex; justify-content: space-between;">
                ...
                <span style="color: #00ca48;">✓ Freebie</span>
              </div>
              <div style="padding: 12px; background: #ffffff; border-radius: 6px; box-shadow: inset 0 0 0 1px #f2f0ed; font-size: 13px; font-weight: 500; display: flex; justify-content: space-between;">
                <span>2. 4-Column Bento Feature Matrix</span>
                <span style="color: #121212;">$39</span>
              </div>
              <div style="padding: 12px; background: #ffffff; border-radius: 6px; box-shadow: inset 0 0 0 1px #f2f0ed; font-size: 13px; font-weight: 500; display: flex; justify-content: space-between;">
                <span>3. Friends of Family Tweet Wall</span>
                <span style="color: #121212;">$24</span>
              </div>
              <div style="padding: 12px; background: #ffffff; border-radius: 6px; box-shadow: inset 0 0 0 1px #f2f0ed; font-size: 13px; font-weight: 500; display: flex; justify-content: space-between;">
      ...
      <!-- 4. FRIENDS OF FAMILY TWEET WALL -->
          ...
          <div style="display: flex; gap: 16px; overflow-x: auto; padding-bottom: 16px; scrollbar-width: none;">
            <div class="card-hairline" style="min-width: 280px; flex: 1;">
              <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                ...
                <span style="font-size: 16px; color: #7e7e7d;">𝕏</span>
              </div>
      ...
      <!-- 5. FINAL ALL-ACCESS BUNDLE BANNER -->
      <section style="padding: 0 0 80px 0;">
        <div class="container">
          <div style="background: #ffffff; border-radius: 14px; padding: 48px 32px; box-shadow: inset 0 0 0 1px #f2f0ed; text-align: center; max-width: 960px; margin: 0 auto; position: relative;">
            <div style="display: inline-flex; align-items: center; gap: 8px; background: #ffcd6c; color: #121212; font-size: 12px; font-weight: 700; padding: 4px 12px; border-radius: 9999px; margin-bottom: 16px;">
              ✦ SPECIAL LIFETIME LAUNCH OFFER
            </div>
